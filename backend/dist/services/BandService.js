...
class BandService {
    ...
    async createBand(bandData) {
        const { name, description, genre, formedYear, websiteUrl, spotifyUrl, instagramUrl, facebookUrl, imageUrl, hometown, } = bandData;
        const query = `
     ...
     */
    async searchBands(searchQuery) {
        const { q = '', genre, rating, page = 1, limit = 20, sort = 'name', order = 'asc', } = searchQuery;
     ...
     * Get bands by genre
     */
    async getBandsByGenre(genre, limit = 20) {
        const query = `
      SELECT id, name, description, genre, formed_year, website_url, spotify_url,
             instagram_url, facebook_url, image_url, hometown, average_rating,
             total_reviews, is_active, created_at, updated_at
...
//# sourceMappingURL=BandService.js.map