...
class VenueService {
    ...
    async createVenue(venueData) {
        const { name, description, address, city, state, country, postalCode, latitude, longitude, websiteUrl, phone, email, capacity, venueType, imageUrl, } = venueData;
        const query = `
     ...
     */
    async searchVenues(searchQuery) {
        const { q = '', city, venueType, rating, page = 1, limit = 20, sort = 'name', order = 'asc', } = searchQuery;
