...
- [ ] **Phase 1: Data Model Foundation** - Redesign schema around events with multi-band lineups, migrate existing data
...
Plans:
- [ ] 04-01: Badge engine redesign (JSONB criteria, evaluator registry, BullMQ async evaluation)
- [ ] 04-02: Concert badge definitions (seed data for all categories + tiers) and anti-farming measures
- [ ] 04-03: Mobile badge UI (collection screen, progress indicators, earned notification, rarity display)
...
Plans:
- [ ] 05-01: FeedService redesign (pull-based with Redis cache, cursor pagination, feed types)
- [ ] 05-02: Real-time layer (WebSocket overlay for FOMO, Redis Pub/Sub for multi-instance fan-out)
- [ ] 05-03: Push notifications (Firebase Cloud Messaging setup, friend activity alert triggers)
